...
const PDFUploader: React.FC<PDFUploaderProps> = ({ onExtract, onUpload }) => {
  ...
  return (
    <div className="col-span-full">
      <label
        htmlFor="pdf-upload"
        className="block text-lg font-medium leading-6 text-black text-center mb-2"
      >
      ...
      <div className="w-64 h-64 mt-2 flex items-center justify-center rounded-lg border border-dashed border-blue-300 bg-blue-100 shadow-lg">
        <div className="text-center">
          ...
          <p className="text-xs leading-10 text-gray-400">
            or drag and drop PDF files up to 10MB
          </p>{' '}
          {/* Update the file type and size */}
        </div>
      </div>
